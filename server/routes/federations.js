...
router.post("/:id/join-requests/:reqId/:decision", requireAuth, async (req, res, next) => {
  try {
    const fedId = Number(req.params.id);
...
router.post("/:id/welfare/disburse", requireAuth, async (req, res, next) => {
  try {
    const fedId = Number(req.params.id);
...
router.post("/:id/disputes/:disputeId/resolve", requireAuth, async (req, res, next) => {
  try {
    const fedId = Number(req.params.id);
